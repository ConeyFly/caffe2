#include "caffe2/image/annotation_input_op.h"

namespace caffe2 {

REGISTER_CPU_OPERATOR(AnnotationInput, AnnotationInputOp<CPUContext>);

OPERATOR_SCHEMA(AnnotationInput)
    .NumInputs(0, 1)
    .NumOutputs(2)
